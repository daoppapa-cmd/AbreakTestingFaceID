...
const translations = {
  km: {
    ...
    cameraPermissionDenied: 'សូមអនុញ្ញាតឲ្យប្រើកាមេរ៉ា (Permission Denied)', 
    ...
    faceScanModeCheckOut: 'របៀប៖ ស្កេនចេញ',
    faceCheckInSuccess: 'ស្កេនចូលបានជោគជ័យ!',
    faceCheckInError: 'មិនអាចស្កេនចូលបាន (ប្រហែលមិនទាន់ចេញ)',
    // !! ថ្មី !!: បន្ថែមពាក្យសម្រាប់អាន
    faceSpeakCheckOut: 'បានស្កេនចេញ',
    faceSpeakCheckIn: 'បានស្កេនចូល',
  },
  en: {
    ...
    faceScanDistance: 'Distance Scan Mode (Slower)', 
    faceScanNormal: 'Normal Scan Mode (Faster)', 
    faceScanModeCheckIn: 'Mode: Check-In',
    faceScanModeCheckOut: 'Mode: Check-Out',
    faceCheckInSuccess: 'Check-in successful!',
    faceCheckInError: 'Check-in failed (Not on break?)',
    // !! ថ្មី !!: បន្ថែមពាក្យសម្រាប់អាន
    faceSpeakCheckOut: 'Scanned Out',
    faceSpeakCheckIn: 'Scanned In',
  }
};
